...
\Author{Matevž Vremec $^{1,\dagger,\ddagger}$\orcidA{}, Veronika Forstner $^{1,,\dagger\ddagger}$ and Steffen Birk $^{2,\dagger,}$*}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=10 cm]{figures/default_pet}
	\caption{Default PET}
\end{figure}   
\begin{table}[H]
	\centering
