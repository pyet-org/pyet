...
def penman(wind, elevation, latitude, rs=None, tmax=None, tmin=None,
           rhmax=None, rhmin=None, rh=None, a=2.6, b=0.536):
    ...
    Examples
    --------
    >>> penman = et.penman(wind, elevation, latitude, rs, tmax, tmin, rh=rh)
    """
    ta = (tmax + tmin) / 2
