...
def pm_fao56(wind, elevation, latitude, solar=None, net=None, sflux=0,
    ...
    if net is None:
        rns = shortwave_r(rs=solar, n=n, nn=nn)  # in #  [MJ/m2/d]
        rnl = longwave_r(rs=solar, tmax=tmax, tmin=tmin, rhmax=rhmax,
...
def longwave_r(rs, tmax=None, tmin=None, rhmax=None, rhmin=None,
    ...
    if rso is None:
        ra = extraterrestrial_r(rs.index, lat)
...
def shortwave_r(rs=None, meteoindex=None, lat=None, alpha=0.23, n=None,
                nn=None):
    """
